package com.example.sai.com.chatbot;
...
public class MainActivityChat extends AppCompatActivity {
        ...
        mTTS = new android.speech.tts.TextToSpeech(this, new android.speech.tts.TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(mTTS.getEngines().size()==0){
                    Toast.makeText(MainActivityChat.this, "NO Text to speech on the device!", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void recordMessage() {
        ...
        if(!listening) {
            ...
            listening = true;
            Toast.makeText(MainActivityChat.this,"Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(MainActivityChat.this,"Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivityChat.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
